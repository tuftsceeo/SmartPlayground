"""
Jump In 2 — Button Press LED Blink
================================
Tap the "jumpin2" NFC tag to enter this mode.
...
_EXIT_TAGS = exit_tags_excluding("jumpin2")
...
def play(nfc, leds, buz, accel, i2c, enow):
    """
    Called from main.py when the "jumpin2" tag is tapped.
    ...
    try:
        JumpIn2Game(nfc, leds, buz, enow).run()
    finally:
        leds.off()
...
def main():
    ...
    """
    print("\n" + "=" * 45)
    print("  Jump In 2 — Button Blink Test")
    print("=" * 45)
