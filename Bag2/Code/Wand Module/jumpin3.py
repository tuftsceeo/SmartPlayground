"""
Jump In 3 — Button Press LED Blink
================================
Tap the "jumpin3" NFC tag to enter this mode.
...
_EXIT_TAGS = exit_tags_excluding("jumpin3")
...
def play(nfc, leds, buz, accel, i2c, enow):
    """
    Called from main.py when the "jumpin3" tag is tapped.
    ...
    try:
        JumpIn3Game(nfc, leds, buz, enow).run()
    finally:
        leds.off()
...
def main():
    ...
    """
    print("\n" + "=" * 45)
    print("  Jump In 3 — Button Blink Test")
    print("=" * 45)
