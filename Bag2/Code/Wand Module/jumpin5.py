"""
Jump In 5 — Button Press LED Blink
================================
Tap the "jumpin5" NFC tag to enter this mode.
...
_EXIT_TAGS = exit_tags_excluding("jumpin5")
...
def play(nfc, leds, buz, accel, i2c, enow):
    """
    Called from main.py when the "jumpin5" tag is tapped.
    ...
    try:
        JumpIn5Game(nfc, leds, buz, enow).run()
    finally:
        leds.off()
...
def main():
    ...
    """
    print("\n" + "=" * 45)
    print("  Jump In 5 — Button Blink Test")
    print("=" * 45)
