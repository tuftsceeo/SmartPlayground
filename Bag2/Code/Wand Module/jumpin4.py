"""
Jump In 4 — Button Press LED Blink
================================
Tap the "jumpin4" NFC tag to enter this mode.
...
_EXIT_TAGS = exit_tags_excluding("jumpin4")
...
def play(nfc, leds, buz, accel, i2c, enow):
    """
    Called from main.py when the "jumpin4" tag is tapped.
    ...
    try:
        JumpIn4Game(nfc, leds, buz, enow).run()
    finally:
        leds.off()
...
def main():
    ...
    """
    print("\n" + "=" * 45)
    print("  Jump In 4 — Button Blink Test")
    print("=" * 45)
