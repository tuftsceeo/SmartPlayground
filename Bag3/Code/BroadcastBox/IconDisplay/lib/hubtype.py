...
programming_station, score_board, or icon_display.
...
_CONFIGS = {
    ...
    # Broadcast icon display: 16x16 WS2812B (256 px) on a XIAO ESP32-C6 plus
    # a Seeed LED driver board. Addressing, orientation and the intensity
