...
# No Matrix import: this module is handed one. Importing the class here
# would invite a second NeoPixel object on the same pin.
from icon_matrix import DEFAULT_INTENSITY, MAX_INTENSITY, W, H, N
...
class IconServer:
    ...
    def run(self):
        ...
        try:
            ...
            self.link.send({"type": "bye"})  # do_repl/do_reboot sent their own
        finally:
            self.finish()
