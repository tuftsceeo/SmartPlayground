# PEER: verbatim copy of Bag3/Code/BroadcastCode/BroadcastBox/BBoxFirmware/ws1850s.py
# (and of BroadcastDial/BDialFirmware/ws1850s.py, itself a copy of it).
# Keep them in sync -- see HARDWARE_PROTOCOL.md's PEER convention.
#
# On the icon display this drives the reader fitted to the XIAO ESP32-C6's
# I2C bus: same chip as the Broadcast Box, on the wand's pins. See
# lib/nfc_ws1850s.py for the shim that lets nfc_reader.py drive it.
"""
