...
def _build_ndef_uri(uri, prefix_code=0):
    """Hand-build a TLV+NDEF URI record for the test below -- mirrors
    build_ndef_text()'s Text-record shape but with type 'U' and a URI
    abbreviation code byte in place of the language-code byte."""
