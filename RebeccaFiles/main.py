# main.py for a plushie module that I added motor/buzzer trigger on startup
import time
import asyncio
import json
import ubinascii
...
class Tool:
    ...
    def startup(self):
        ...
        # Test 1: Direct motor control
        self.button.motor.start()
        time.sleep(0.3)
        self.button.motor.stop()
            
        # Test 2: Direct buzzer control
