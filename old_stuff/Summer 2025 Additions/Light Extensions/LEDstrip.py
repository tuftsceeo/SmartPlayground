#LED Strip
#save as main.py / run in the LED strip esp
import time
import math
import random
...
pin2 = machine.Pin(23)  #using an esp shield
num_leds2 = 30  # change based on the amount of lights in the strip
numberofLED = num_leds2
    ...
    while True:  # Read out all messages waiting in the buffer
        ...
        if msg:             # msg == None if timeout in recv()
            ...
            try:
                ...
                print("active", active)
                time.sleep(0.1)
                print(msg_json[0],msg_json[1],msg_json[2],msg_json[3])
