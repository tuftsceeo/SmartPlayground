...
def client_handler(connection, stop_event):
    ...
    motion_level = 0
    total_pixels = video_stream.camera.resolution[0] * video_stream.camera.resolution[1]
    max_motion_pixels = total_pixels  # You can adjust this if needed
    ...
    try:
        ...
        while not stop_event.is_set():
            ...
            if new and frame is not None:
                ...
                if motion_level != 0: #motion levels above 0 as 1 to 10.
                    motion_level = min(motion_level / max_motion_pixels, 1.0) * 9
                    motion_level = round(motion_level)+1
                ...
                try:
                    connection.sendall(str(motion_level).encode())
